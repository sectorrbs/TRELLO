...
class RoomPartyController extends Controller
{
    ...
    public function addUserRoomParty(RoomPartyRequest $request, RoleService $role)
    {
    ...
    public function addUsersRoomParty(Request $request, RoleService $role)
    {
    ...
    public function appointmentUserRegularRoomParty(RoomParty $roomParty, RoleService $role)
    {
        $roomParty->update([
    ...
    public function appointmentUserGuestRoomParty(RoomParty $roomParty, RoleService $role)
    {
        $roomParty->update([
            'role_id' => $role->getRoleGuestById()
        ]);
        return response(null, Response::HTTP_NO_CONTENT);
    }
